...
namespace KnightGame
{
    public class KnightGame
    {
            ...
            while (true)
            {
                for (int rowIndex = 0; rowIndex < matrix.Length; rowIndex++)
                {
                    for (int colIndex = 0; colIndex < matrix[rowIndex].Length; colIndex++)
                    {
                        ...
                        {
                            currentKnightsInDanger = Check(matrix, currentKnightsInDanger, rowIndex, colIndex);
                        }
        ...
        private static int Check(char[][] matrix, int currentKnightsInDanger, int rowIndex, int colIndex)
        {
            // vertical and left
